...
inline explicit CUDAStream([Stream](../c10/streams.html#_CPPv4N3c106StreamE) stream)

Construct a CUDAStream from a [Stream](../c10/streams.html#PyTorchclassc10_1_1_stream).

This construction is checked, and will raise an error if the [Stream](../c10/streams.html#PyTorchclassc10_1_1_stream) is not, in fact, a CUDA stream.

inline explicit CUDAStream(Unchecked, [Stream](../c10/streams.html#_CPPv4N3c106StreamE) stream)

Construct a CUDAStream from a [Stream](../c10/streams.html#PyTorchclassc10_1_1_stream) with no error checking.
...
Implicit conversion to [Stream](../c10/streams.html#PyTorchclassc10_1_1_stream) (a.k.a., forget that the stream is a CUDA stream).
...
The [Device](../c10/device.html#PyTorchstructc10_1_1_device) is guaranteed to be a CUDA device.
...
Previously the stream's data was packed into a single int64_t, as it was assumed the fields would not require more than 64 bits of storage in total. See [pytorch/pytorch#75854](https://github.com/pytorch/pytorch/issues/75854) for more information regarding newer platforms that may violate this assumption.

The CUDAStream can be unpacked using unpack().

Public Static Functions

static inline CUDAStream unpack3(StreamId stream_id, DeviceIndex device_index, [DeviceType](../c10/device.html#_CPPv4N3c1010DeviceTypeE) device_type)
