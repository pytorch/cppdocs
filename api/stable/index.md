...
- [Library Registration Macros](registration.html)
- [Stable Operators](operators.html)
- [Utilities](utilities.html)

## See Also

- [Torch Library API](../library/index.html) - For standard (non-stable) operator registration
