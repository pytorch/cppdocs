...
- `c10/cuda/CUDAGuard.h` - CUDA device guards (see [CUDA Support](../cuda/index.html))
- `c10/cuda/CUDAStream.h` - CUDA stream management (see [CUDA Support](../cuda/index.html))
- `c10/xpu/XPUStream.h` - Intel XPU stream management
- `ATen/core/ivalue.h` - IValue for TorchScript interop

## C10 Categories

- [Device and DeviceType](device.html)
- [Device Guards](guards.html)
- [Streams](streams.html)
- [Core Types](types.html)
