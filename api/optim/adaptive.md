...
class Adam : public torch::optim::[Optimizer](index.html#_CPPv4N5torch5optim9OptimizerE)

Public Functions

inline explicit Adam(const std::vector<[OptimizerParamGroup](index.html#_CPPv4N5torch5optim19OptimizerParamGroupE)> ¶m_groups, AdamOptions defaults = {})

inline explicit Adam(std::vector<[Tensor](../aten/tensor.html#_CPPv46Tensorv)> params, AdamOptions defaults = {})
...
class AdamW : public torch::optim::[Optimizer](index.html#_CPPv4N5torch5optim9OptimizerE)

Public Functions

inline explicit AdamW(const std::vector<[OptimizerParamGroup](index.html#_CPPv4N5torch5optim19OptimizerParamGroupE)> ¶m_groups, AdamWOptions defaults = {})

inline explicit AdamW(std::vector<[Tensor](../aten/tensor.html#_CPPv46Tensorv)> params, AdamWOptions defaults = {})
...
class RMSprop : public torch::optim::[Optimizer](index.html#_CPPv4N5torch5optim9OptimizerE)

Public Functions

inline explicit RMSprop(const std::vector<[OptimizerParamGroup](index.html#_CPPv4N5torch5optim19OptimizerParamGroupE)> ¶m_groups, RMSpropOptions defaults = {})

inline explicit RMSprop(std::vector<[Tensor](../aten/tensor.html#_CPPv46Tensorv)> params, RMSpropOptions defaults = {})
...
class Adagrad : public torch::optim::[Optimizer](index.html#_CPPv4N5torch5optim9OptimizerE)

Public Functions

inline explicit Adagrad(const std::vector<[OptimizerParamGroup](index.html#_CPPv4N5torch5optim19OptimizerParamGroupE)> ¶m_groups, AdagradOptions defaults = {})

inline explicit Adagrad(std::vector<[Tensor](../aten/tensor.html#_CPPv46Tensorv)> params, AdagradOptions defaults = {})
